<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"D:\study\PHPTutorial\WWW\TP5\public/../application/admin\view\auth_rule\lst.html";i:1509024814;s:80:"D:\study\PHPTutorial\WWW\TP5\public/../application/admin\view\common\header.html";i:1510320344;s:77:"D:\study\PHPTutorial\WWW\TP5\public/../application/admin\view\common\top.html";i:1510320654;s:78:"D:\study\PHPTutorial\WWW\TP5\public/../application/admin\view\common\left.html";i:1510320674;s:78:"D:\study\PHPTutorial\WWW\TP5\public/../application/admin\view\common\foot.html";i:1508420199;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
    <title>权限管理系统</title>
                            ...
                            <div class="widget-body">
                                ...
                                <form action="#" method="post">
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$AdminRule): $mod = ($i % 2 );++$i;?>
                                                <tr>
                                                    <td align="center"><?php echo $AdminRule['id']; ?></td>
                                                    <td align="center"><input name="<?php echo $AdminRule['id']; ?>" type="text" style="width:50px; text-align:center;" value="<?php echo $AdminRule['sort']; ?>"></td>
                                                    <td align="left"><?php if($AdminRule['pid'] != 0){echo '|'; }; echo str_repeat('--',$AdminRule['level']*2) ?><?php echo $AdminRule['name']; ?></td>
                                                    <td align="center"><?php echo $AdminRule['title']; ?></td>
                                                    <td align="center"><?php echo $AdminRule['level']+1; ?>级</td>
                                                    <td align="center">
                                                        <a href="<?php echo url('edit',array('id'=>$AdminRule['id'])); ?>" class="btn btn-primary btn-sm shiny">
                                                            <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <a href="javascript:void(0);" onclick="warning('确认删除?','<?php echo url('AuthRule/del',array('id'=>$AdminRule['id'])); ?>')"  class="btn btn-danger btn-sm shiny">
