<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:81:"D:\study\PHPTutorial\WWW\TP5\public/../application/admin\view\auth_rule\edit.html";i:1509270558;s:80:"D:\study\PHPTutorial\WWW\TP5\public/../application/admin\view\common\header.html";i:1508419877;s:77:"D:\study\PHPTutorial\WWW\TP5\public/../application/admin\view\common\top.html";i:1509538865;s:78:"D:\study\PHPTutorial\WWW\TP5\public/../application/admin\view\common\left.html";i:1508759517;s:78:"D:\study\PHPTutorial\WWW\TP5\public/../application/admin\view\common\foot.html";i:1508420199;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                                    ...
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <select name="pid">
                                                    ...
                                                    <?php if(is_array($AdminRule) || $AdminRule instanceof \think\Collection || $AdminRule instanceof \think\Paginator): $i = 0; $__LIST__ = $AdminRule;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                                    <option value="<?php echo $vo['id']; ?>" <?php if($admin['pid'] == $vo['id']): ?> selected <?php endif; ?>><?php if($vo['pid'] != 0): ?>|<?php endif; ?><?php echo str_repeat('--',$vo['level']*2)?><?php echo $vo['name']; ?></option>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control"  placeholder="" name="title" required="" type="text" value=<?php echo $admin['title']; ?>>
                                            </div>
